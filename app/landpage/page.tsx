...
import { ActionButton, AnswerWrapper, ClientSupport, Container, ContentHolder, FAQ, FAQText, FeatureText, FeatureWrapper, Features, FeaturesContainer, IconWrapper, Integrations, Introduction, MainText, OrangeGradient, Question, QuestionsHolder, QuestionsWrapper, SecodaryText, SecondSection, SecondSectionText, VideoSection, Wrapper } from './styles';
