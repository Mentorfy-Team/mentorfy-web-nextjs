...
import UpdateCookies from '@app/backend/helpers/UpdateCookies';
import { fixBase64 } from '@app/backend/http/products';
import { GetCustomerPagarme } from '@app/backend/repositories/user/GetCustomerPagarme';
import { SupabaseAdmin, SupabaseServer } from '@app/backend/supabase';
