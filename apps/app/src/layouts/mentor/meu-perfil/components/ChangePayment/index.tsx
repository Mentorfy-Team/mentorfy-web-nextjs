...
import CreditCardFields from '@app/components/modules/CreditCardFields';
import {
  FormProvider,
  SubmitErrorHandler,
  SubmitHandler,
...
import {
  ICheckoutCard,
  checkoutCardSchema,
} from '@app/layouts/checkout/validation';
import { zodResolver } from '@hookform/resolvers/zod';
import PaymentMethPicker from '@app/components/modules/PaymentMethPicker/index.';
import { toast } from 'react-toastify';
import CustomerFields from '@app/layouts/checkout/components/CustomerFields';
import { UpdateSubscriptionService } from '@app/services/subscription/UpdateSubscription.service';
import { ChangeSubscriptionToPixService } from '@app/services/subscription/ChangeSubscriptionToPix.service';
import { CreateSubscriptionService } from '@app/services/subscription/CreateSubscription.service';
type Props = {
  open: boolean;
