...
import { useMemberAreaTools } from '@app/hooks/useMemberAreaTools';
import { ToolListNames } from '@app/layouts/mentor/area-de-membros/helpers/SwitchModal';
import SwitchModal from '@app/layouts/mentor/area-de-membros/helpers/SwitchModal';
import { FilesToDelete } from '@app/services/file-upload.service';
import { UpdateMemberAreaTools } from '@app/services/member-area.service';
...
const DragNDrop = dynamic(() => import('@app/components/modules/DragNDrop'), {
  ssr: false,
});
