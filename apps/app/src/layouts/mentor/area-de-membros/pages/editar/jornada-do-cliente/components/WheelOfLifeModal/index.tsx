...
import TextRating from '@app/components/atoms/Rating';
import WheelOfLifeTemplate from '@app/layouts/mentorado/components/wheel-of-Life/template/WheelOfLifeTemplate';
