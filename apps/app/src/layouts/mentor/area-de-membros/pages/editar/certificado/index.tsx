...
import { DefaultCertificate } from '@app/consts/certificate';
import { toast } from 'react-toastify';
import { DragBox } from './components/DragBox';
import { SingFont } from '@app/pages/_app';
import UploadToUrlFiles from '../../../components/UploadFileModal/helpers/UploadToUrlFiles';
import { UpdateCertificate } from '@app/services/certificate-upload.service';

import NextImage from 'next/image';
import { Button } from '@mui/material';

const PDFReader = dynamic(
  () => import('@app/components/atoms/PDFReader/PDFReader'),
  {
    ssr: false,
  },
);
