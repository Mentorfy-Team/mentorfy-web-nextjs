...
import Tipografia from '@app/../public/images/logo-montanha.png';
import MenuAvatar from '@app/../public/svgs/menu-avatar';
import Notification from '@app/../public/svgs/notification';
