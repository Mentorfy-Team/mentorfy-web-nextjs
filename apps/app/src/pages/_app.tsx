...
import { GlobalStyles, ThemeProvider } from '@app/theme';
...
const LoadingPartial = dynamic(
  () => import('@app/components/partials/loading/loading.partial'),
);
const MiniDrawer = dynamic(() => import('@app/components/partials/MiniDrawer'));
const HeaderPartial = dynamic(
  () => import('@app/components/partials/HeaderPartial'),
);
