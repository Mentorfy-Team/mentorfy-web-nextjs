  ...
  return (
    ...
    >
      ...
      <ModalDialogContent sx={{ padding: '0.8rem', gap: '1rem' }}>
        ...
        <Typography sx={{ fontWeight: '500', fontSize: '1.2rem', marginBottom: '1.2rem' }}>
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', gap: '1.2rem', cursor: 'pointer' }} onClick={() => { setShowPix(!showPix); setShowCard(false); }}>
            <Checkbox checked={showPix} color='success' size='small' sx={{ padding: '0px', color: 'tertiary.light' }} />
            <Typography sx={{ fontWeight: 'bold', fontSize: '1.2rem' }}>
              Pix
            </Typography>
          </Box>
          <Box sx={{ display: 'flex', gap: '1.2rem', cursor: 'pointer' }} onClick={() => { setShowCard(!showCard); setShowPix(false); }}>
            <Checkbox checked={showCard} color='success' size='small' sx={{ padding: '0px', color: 'tertiary.light' }} />
            <Typography sx={{ fontWeight: 'bold', fontSize: '1.2rem' }}>
              Cartão de Crédito
            </Typography>
          </Box>
        ...
        {showCard &&
          <Form
            ...
            <Input
              ...
              color='secondary'
              onChange={(e) =>
                handleData(e, 'card', 'card_holder_name')
              }
            />
            <InputsWrapper>
              <Input
